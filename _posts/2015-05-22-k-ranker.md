...
1차 선별 데이타를 통해 [커브 피팅(Curve fitting)](http://en.wikipedia.org/wiki/Curve_fitting)을 진행했고 두 개 이상의 파티션으로 나누어 수식의 복잡성을 줄이고 2차 다항식으로 제한했다.
...
[Fork on GitHub](https://github.com/likejazz/k-ranker)
