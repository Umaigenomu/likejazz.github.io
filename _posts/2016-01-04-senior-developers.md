...
주장하는 바가 서비스 개발을 매도하고 시스템 개발만이 최고라는 얘기가 아니다. 알고리즘이 최고이며 과학자가 되라는 얘기도 아니다. 내 주장은 서비스 개발자를 타겟으로 하는게 맞다. 나 또한 서비스 개발을 주 업무로 하고 있으며 서비스 개발이 가장 즐겁다. 주장의 핵심은 '**시스템 개발을 이해하고, 서비스 개발을 해야 한다**'는 것이다. 시스템을 모르고 서비스 개발을 해선 안된다. 당연히 시스템을 얼마나 잘 이해하느냐에 따라 서비스 품질에도 차이가 난다.
...
메소드명을 `setRankRange()`로 정하고 주석으로 부가 설명을 하는건 틀린 방식인가? 간단히 설명할 수 있는 것을 굳이 풀어쓰고 그게 더 우월하다고 얘기할 수 있는가. 저렇게 긴 메소드명은 대체 어떻게 입력할 것인가. 'IDE 가 있잖아' 라고 얘기한다. 그렇다. 클린 코드는 IDE 에 의존적이며 책에서도 지속적으로 언급하고 있다. 그렇다면 마찬가지다. `setRankRange()` 메소드에 Javadoc 을 달아두면 마우스를 갖다대기만 해도 내가 달아둔 상세한 주석이 툴팁으로 뜬다. IDE 가 처리해주는데 아무 문제될게 없다.
...
나는 기반 기술에 대한 이해도 차이가 서비스 개발의 쥬니어와 시니어를 구분하는 결정적인 요인이라고 생각한다. 그리고 이는 서비스 품질과 연결된다. 그렇지 않다면 기업에서 시니어를 고용할 이유가 없다. 간혹 시니어가 되어서도 쥬니어와 같은 일을 하고 싶다는 사람들이 있는데, 개인은 그렇게 하여 행복할지 모르겠으나 기업은 그렇지 않다. 쥬니어와 시니어가 같은 일을 하고 같은 품질의 결과물을 만들어 내는데 나이는 많고 연봉은 더 높다면 시니어를 반길 이유가 있을까. 1년의 경력을 10번 반복한 시니어가 쥬니어에 비해 갖는 경쟁력은 과연 무엇일까. 기업은 원치 않는다. 결국 개인에게도 불행이다.