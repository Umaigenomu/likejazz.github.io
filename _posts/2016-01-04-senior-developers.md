...
클린 코드는 좋은 코드를 위한 훌륭한 지침서다. 그러나 모든 지침이 절대적인 사항은 아니며 주관적인 부분이 많은 부분을 차지한다. 지금 시점에서 맞지 않는 부분도 있다. 책에서도 '적어도 내게는 그렇다'는 문장이 수시로 등장한다. 저자는 책 내용이 주관적일 수 있다는 점을 분명히 하고 있다. 
...
아울러 [클린 코드를 다시 읽으며](http://likejazz.com/post/136399435650/%ED%81%B4%EB%A6%B0-%EC%BD%94%EB%93%9C%EB%A5%BC-%EB%8B%A4%EC%8B%9C-%EC%9D%BD%EA%B3%A0) 마찬가지로 일관된 주장을 했다. "아는 만큼 보인다"
...
이 문장이 핵심인데, 주변의 다른 표현들 때문에 핵심 문장이 묻혀버렸다. 이 또한 내 불찰이며, 안타까운 부분이다.
