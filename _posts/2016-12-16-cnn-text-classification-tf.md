...
NLP 전처리를 위해서는 한글 형태소 분석기가 필수적인데 여기서는 카카오 사내 고성능 형태소 분석기인 DHA를 사용했다. 우수한 형태소 분석기이지만 아쉽게도 DHA는 사내 솔루션이며 외부에 공개되지 않는다. 따라서 더 이상 소개할 수 없는 점 양해 바란다. 공개된 [KoNLPy](http://konlpy.org/ko/latest/)등의 오픈소스 형태소 분석기를 활용할 수 있을 것이다.
