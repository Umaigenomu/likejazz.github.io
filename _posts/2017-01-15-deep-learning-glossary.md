...
*2017년 1월 15일 초안 작성*
  ...
  - [손실 함수<sup>Cost or Loss or Error Functions</sup>](#-supcost-or-loss-or-error-functions3sup)
  - [미분](#section-1)
...
[^15]
역전파를 사용하지 않고 기울기를 구하려면 모든 w 값에 대해 수치 미분을 구해야 하며 따라서 모든 w에 대해 손실 함수를 계산해야 한다. 매우 느림

역전파를 사용하면 W에 대한 수치 미분만 계산하면 된다.
