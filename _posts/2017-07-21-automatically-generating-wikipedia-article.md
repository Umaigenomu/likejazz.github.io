...
아래에 논문을 번역하여 소개합니다. 비문인 경우에는 가능한 수정하려고 노력했지만 직역체라 다소 어색할 수 있는 점은 양해바랍니다.
...
각 주제 $$t_j$$에 대해 주어진 발췌의 품질을 결정하기 위해 해당 주제별 매개 변수 $$w_j$$를 학습합니다. 전역 최적화를 위해 ILP 공식으로 보강된 퍼셉트론 프레임 워크를 사용하여 시스템은 각 문서 $$d_i$$와 각 주제 $$t_j$$에 대한 최상의 발췌를 선택하도록 학습됩니다. 학습을 위해 가장 좋은 발췌 부분이 인간이 작성한 원본 텍스트 $$s_{ij}$$라고 가정합니다.
...
이 기사는 위키피디어에서 5에서 11개월간 남아 있었습니다. 문서 모두는 편집되었으나 품질 부족으로 인해 삭제된 기사는 없었습니다.
