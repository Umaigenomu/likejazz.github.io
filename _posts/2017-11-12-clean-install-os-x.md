...
### 자료
개인 자료의 경우 사진과 비디오는 이미 **Google Photos**를 적극 활용하고 그외 블로그와 기타 이미지 호스팅 용도로 **GitHub**의 Issues를 활용한다. 비디오 중 공개적인건 **YouTube**에, 음악은 따로 다운받지 않고 **멜론** 스트리밍을 사용하고, 문서는 **Dropbox**와 **iCloud Drive**에 적절히 나눠 저장하고, 오피스 문서는 **OneDrive**에, 정리가 필요한 문서는 **GitHub** 위키에 마크다운으로 작성한다. 공개적인 코드는 **GitHub**에 회사 업무용은 사내 **GitHub Enterprise**에 둔다.
