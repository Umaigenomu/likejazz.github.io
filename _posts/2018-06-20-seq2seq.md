...
## 일반적인 형태
[Keras 공식 블로그에서도 소개](https://blog.keras.io/a-ten-minute-introduction-to-sequence-to-sequence-learning-in-keras.html)한 바 있는 Seq2Seq의 일반적인 형태는 좀 더 복잡하다. sequences 뿐만 아니라 states도 함께 사용하며, 학습과 추론의 입출력이 조금 다르다.
### 학습
<img width="70%" src="https://user-images.githubusercontent.com/1250095/42202348-fd526dae-7ed5-11e8-8015-76ebf2c545ac.png">
인코더의 states. 즉, hidden state와 cell state를 디코더의 입력으로 학습한다. 디코더의 states는 사용하지 않는다.

### 추론
<img width="70%" src="https://user-images.githubusercontent.com/1250095/42202355-03059686-7ed6-11e8-9047-e472e7c25a1f.png">
