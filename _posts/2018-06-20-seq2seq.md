...
## 일반적인 형태
[Keras 공식 블로그에서 소개](https://blog.keras.io/a-ten-minute-introduction-to-sequence-to-sequence-learning-in-keras.html)된 Seq2Seq의 일반적인 형태는 보다 복잡하다. input과 output이 모두 가변 길이 이고, sequences 뿐만 아니라 states를 함께 사용한다. (Cho et al., 2014)[^fn-3] 
