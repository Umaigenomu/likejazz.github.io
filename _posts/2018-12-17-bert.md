...
#### KorQuAD
본 내용을 바탕으로 한글 모델의 성능을 실험하기 위해 <a href="http://korquad.github.io">KorQuAD</a>에 참여하여 state-of-the-art를 달성하는 좋은 성과를 거두었다. <strong>EM, F1 모두 1위를 기록</strong>함은 물론, Human Performance를 능가하는 첫 번째 모델을 제출하였다.
