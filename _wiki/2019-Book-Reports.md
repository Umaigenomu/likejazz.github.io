...
알고리즘 대회를 위한 고급 기법을 전수하는 책. 여러가지 기법의 핵심을 간략하게 언급한다. 그러나, 예제 코드가 부족하고 단순히 설명만 하고 지나가다 보니 여러 알고리즘을 나열한 백과사전 느낌이 난다.

# 코딩 인터뷰 퀘스천 <sub>2012, 2015</sub>
2017년에 읽고, 2년만에 다시 꺼내들어 읽었다. 유용하지만 일부 잘못된 정보도 있고, 깊이가 부족하다.

# 쉽게 배우는 알고리즘 <sub>2018</sub>
저자는 서울대 컴퓨터 공학부 교수로, 중간중간 소개하는 사례들에서 통찰력이 넘친다. 알고리즘의 전문가가 적은 책이라 여유있는 필체가 돋보인다.
