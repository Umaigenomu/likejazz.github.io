...
수능 수학에서 점수를 잘 받기 위해 어떤 과목을, 어떤 과정으로 공부해야 하는지를 기술한 책. 그러나 높은 점수를 위해 갖은 편법을 사용하라는 책이 아니라 출제 빈도가 낮고 상대적으로 현실에서 유용하지 않은 챕터를 과감히 건너 뛰고 현대 과학에 중요한 부분 위주로, 출제가 잦은 과목 위주로 공부해야 한다는 실용적인 주장을 한다.
