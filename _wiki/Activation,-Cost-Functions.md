...
```
sess.run(tf.matmul(X, W), feed_dict={X: x_data, Y: y_data})
Out[44]: 
array([[  0.641364  ,  -3.625635  ,   2.9831805 ],
       [  0.8079863 ,  -4.8153095 ,   4.005331  ],
       [  0.38511974,  -3.0448952 ,   2.6573267 ],
       [  2.0476773 ,   4.419237  ,  -6.4680767 ],
       [  3.698092  ,   8.852425  , -12.550736  ],
       [  0.2427826 ,   4.20667   ,  -4.4503098 ],
       [  1.7671478 ,  -1.0619116 ,  -0.7084446 ],
       [  2.4474037 ,  -1.189085  ,  -1.2603989 ]], dtype=float32)
sess.run(tf.nn.softmax(tf.matmul(X, W)), feed_dict={X: x_data, Y: y_data})
Out[45]: 
array([[0.08761067, 0.00122864, 0.91116065],
       [0.03926019, 0.00014184, 0.96059793],
       [0.09316909, 0.00301742, 0.90381354],
       [0.08536581, 0.91461706, 0.0000171 ],
       [0.00574118, 0.99425876, 0.        ],
       [0.0186321 , 0.9811972 , 0.00017064],
       [0.8747517 , 0.05167017, 0.07357812],
       [0.951587  , 0.02506926, 0.02334373]], dtype=float32)
```
