...
두 수의 차가 2인 소수의 쌍. 즉, $$(p, p+2)$$
- 메르센 소수 <sup>Mersenne number</sup>  
p가 소수이고, $$2^p - 1$$이 소수일때
...
# 로그
<img src="http://www.librow.com/content/common/images/articles/article-11/graph-exp.gif" width="30%">

$$y = e^x$$ ([ref](http://www.librow.com/articles/article-11/appendix-a-20))
...
- 카지노에서의 수 싸움  
카드 카운팅을 발명한 에드워드 소프. 경우의 수 <sup>number of cases</sup>에서 카드 카운팅은 계산하기가 조금 복잡한 편.
