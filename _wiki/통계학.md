...
- [책](#책)
    - [통계학을 떠받치는 일곱기둥 이야기](#통계학을-떠받치는-일곱기둥-이야기)
        - [1. Aggregation: From Tables and Means to Least Squares](#1-aggregation-from-tables-and-means-to-least-squares)
        - [2. Information: Its Measurement and Rate of Change](#2-information-its-measurement-and-rate-of-change)
        - [3. Likelihood: Calibration on a Probability Scale](#3-likelihood-calibration-on-a-probability-scale)
        - [4. Intercomparison: Within-Sample Variation as a Standard](#4-intercomparison-within-sample-variation-as-a-standard)
        - [5. Regression: Multivariate Analysis, Bayesian Inference, and Causal Inference](#5-regression-multivariate-analysis-bayesian-inference-and-causal-inference)
        - [6. Design: Experimental Planning and the Role of Randomization](#6-design-experimental-planning-and-the-role-of-randomization)
        - [7. Residual: Scientific Logic, Model Comparison, and Diagnostic Display](#7-residual-scientific-logic-model-comparison-and-diagnostic-display)
